...
static int _modbus_rtu_connect(modbus_t *ctx)
{
    ...
    /* Speed setting */
    switch (ctx_rtu->baud) {
      //Add BaudRate : 1250 000 into it @warheat
    ...
    */
    ...
    case 115200:
        speed = B115200;
        break;
        printf("BaudRate Debug :115200 \n");
    case 1250000:
        speed = B1152000;//Added by Warheat 12.22
        printf("BaudRate Debug :1250000 using B1152000(WARNING)\n");
        break;
    default:
        speed = B9600;
        if (ctx->debug) {
